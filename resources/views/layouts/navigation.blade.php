<<<<<<< HEAD
<nav x-data="{ open: false }" class="bg-[#E6E6E6] border-b border-gray-100" >
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{ asset('images/LogoRS.png') }}" alt="logo" class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
            </div>
   ...
   <div class="bg-[#D9D9D9] rounded-[20px]">
     <div class="bg-[#E6E6E6]  rounded-[20px]">
       ...
       <div class="flex items-center justify-center">
           <a href="{{ route('dashboard') }}">
               <img src="{{ asset('images/LogoRS.png') }}" alt="logo" class="h-8 w-auto" />
           </a>
       </div>
           <div class="flex ml-auto">
       <!-- Beranda -->
       <div class="px-3 py-2 text-gray-800 hover:text-white font-semibold">
